  ...
  <div class="mb-2">
    ...
    >
      ...
      >
        ...
        >
          <span class="absolute top-1/2 left-1/2 z-10 text-lg font-semibold text-white transform -translate-x-1/2 -translate-y-1/2 md:text-xl lg:text-3xl">+{{ album._count.album_has_artworks-4 }}</span>
