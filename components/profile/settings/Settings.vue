        ...
        <div class="field">
          <label :for="!inputData.showExplicit ? 'checked' : 'unchecked'" class="inline-flex items-center mt-2">
            <span class="relative cursor-pointer" @click="inputData.showExplicit = !inputData.showExplicit">
              ...
              <span v-if="!inputData.showExplicit" class="block absolute inset-y-0 left-0 mt-1 ml-1 w-4 h-4 bg-white rounded-full shadow transition-transform duration-300 ease-in-out focus-within:shadow-outline">
