...
export const SearchApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        async searchArtworks(keyword: string, range: string, by: string, page: number, perPage: number, mode?: string, following?: boolean, recent?: boolean, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => Promise<AxiosResponse<InlineResponse20028>>> {
...
export const SearchApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
         ...
         * @throws {RequiredError}
         */
        async searchArtworks(keyword: string, range: string, by: string, page: number, perPage: number, mode?: string, following?: boolean, recent?: boolean, options?: AxiosRequestConfig): Promise<AxiosResponse<InlineResponse20028>> {
...
export class SearchApi extends BaseAPI {
     ...
     * @memberof SearchApi
     */
    public async searchArtworks(keyword: string, range: string, by: string, page: number, perPage: number, mode?: string, following?: boolean, recent?: boolean, options?: AxiosRequestConfig) : Promise<AxiosResponse<InlineResponse20028>> {
