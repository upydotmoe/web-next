...
export const ArtworkTagsApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        async getAllTags(orderMode?: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => Promise<AxiosResponse<InlineResponse20031>>> {
         ...
         * @throws {RequiredError}
         */
        async getKeysByTags(tags: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => Promise<AxiosResponse<InlineResponse20033>>> {
         ...
         * @throws {RequiredError}
         */
        async getUserTopTags(userId: number, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => Promise<AxiosResponse<InlineResponse20034>>> {
         ...
         * @throws {RequiredError}
         */
        async searchTags(keyword: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => Promise<AxiosResponse<Array<InlineResponse20032>>>> {
...
export const ArtworkTagsApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
         ...
         * @throws {RequiredError}
         */
        async getAllTags(orderMode?: string, options?: AxiosRequestConfig): Promise<AxiosResponse<InlineResponse20031>> {
         ...
         * @throws {RequiredError}
         */
        async getKeysByTags(tags: string, options?: AxiosRequestConfig): Promise<AxiosResponse<InlineResponse20033>> {
         ...
         * @throws {RequiredError}
         */
        async getUserTopTags(userId: number, options?: AxiosRequestConfig): Promise<AxiosResponse<InlineResponse20034>> {
         ...
         * @throws {RequiredError}
         */
        async searchTags(keyword: string, options?: AxiosRequestConfig): Promise<AxiosResponse<Array<InlineResponse20032>>> {
...
export class ArtworkTagsApi extends BaseAPI {
     ...
     */
    public async getAllTags(orderMode?: string, options?: AxiosRequestConfig) : Promise<AxiosResponse<InlineResponse20031>> {
     ...
     * @memberof ArtworkTagsApi
     */
    public async getKeysByTags(tags: string, options?: AxiosRequestConfig) : Promise<AxiosResponse<InlineResponse20033>> {
     ...
     * @memberof ArtworkTagsApi
     */
    public async getUserTopTags(userId: number, options?: AxiosRequestConfig) : Promise<AxiosResponse<InlineResponse20034>> {
     ...
     * @memberof ArtworkTagsApi
     */
    public async searchTags(keyword: string, options?: AxiosRequestConfig) : Promise<AxiosResponse<Array<InlineResponse20032>>> {
