...
export const NotificationsMarkersUsersApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        async getUserFollowMarker(options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => Promise<AxiosResponse<InlineResponse20021>>> {
...
export const NotificationsMarkersUsersApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
         ...
         * @throws {RequiredError}
         */
        async getUserFollowMarker(options?: AxiosRequestConfig): Promise<AxiosResponse<InlineResponse20021>> {
...
export class NotificationsMarkersUsersApi extends BaseAPI {
     ...
     */
    public async getUserFollowMarker(options?: AxiosRequestConfig) : Promise<AxiosResponse<InlineResponse20021>> {
