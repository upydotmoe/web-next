...
export const NotificationsMarkersApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        async getMarkers(options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => Promise<AxiosResponse<InlineResponse20021>>> {
...
export const NotificationsMarkersApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
         ...
         * @throws {RequiredError}
         */
        async getMarkers(options?: AxiosRequestConfig): Promise<AxiosResponse<InlineResponse20021>> {
...
export class NotificationsMarkersApi extends BaseAPI {
     ...
     * @memberof NotificationsMarkersApi
     */
    public async getMarkers(options?: AxiosRequestConfig) : Promise<AxiosResponse<InlineResponse20021>> {
