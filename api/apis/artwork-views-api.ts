...
export const ArtworkViewsApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        async countViews(id: number, mode: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => Promise<AxiosResponse<InlineResponse20026>>> {
...
export const ArtworkViewsApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
         ...
         * @throws {RequiredError}
         */
        async countViews(id: number, mode: string, options?: AxiosRequestConfig): Promise<AxiosResponse<InlineResponse20026>> {
...
export class ArtworkViewsApi extends BaseAPI {
     ...
     * @memberof ArtworkViewsApi
     */
    public async countViews(id: number, mode: string, options?: AxiosRequestConfig) : Promise<AxiosResponse<InlineResponse20026>> {
