...
export const ArtworkCRUDApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @param {number} [redrawInMyStyle] 
         * @param {number} [isOriginalCharacter] 
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        postForm: async (title?: string, description?: string, tags?: string, isExplicit?: number, scheduledPost?: string, files?: Array<Blob>, fileOrder?: Array<number>, allowRedraw?: number, redrawOf?: number, redrawInMyStyle?: number, isOriginalCharacter?: number, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            ...
            if (redrawInMyStyle !== undefined) { 
                localVarFormParams.append('redraw_in_your_style', redrawInMyStyle as any);
            }
...
export const ArtworkCRUDApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        async postForm(title?: string, description?: string, tags?: string, isExplicit?: number, scheduledPost?: string, files?: Array<Blob>, fileOrder?: Array<number>, allowRedraw?: number, redrawOf?: number, redrawInMyStyle?: number, isOriginalCharacter?: number, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => Promise<AxiosResponse<InlineResponse2011>>> {
            const localVarAxiosArgs = await ArtworkCRUDApiAxiosParamCreator(configuration).postForm(title, description, tags, isExplicit, scheduledPost, files, fileOrder, allowRedraw, redrawOf, redrawInMyStyle, isOriginalCharacter, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs :AxiosRequestConfig = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
...
export const ArtworkCRUDApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
         ...
         * @throws {RequiredError}
         */
        async postForm(title?: string, description?: string, tags?: string, isExplicit?: number, scheduledPost?: string, files?: Array<Blob>, fileOrder?: Array<number>, allowRedraw?: number, redrawOf?: number, redrawInMyStyle?: number, isOriginalCharacter?: number, options?: AxiosRequestConfig): Promise<AxiosResponse<InlineResponse2011>> {
            return ArtworkCRUDApiFp(configuration).postForm(title, description, tags, isExplicit, scheduledPost, files, fileOrder, allowRedraw, redrawOf, redrawInMyStyle, isOriginalCharacter, options).then((request) => request(axios, basePath));
        },
        /**
         * 
         * @summary Update existing artwork information
...
export class ArtworkCRUDApi extends BaseAPI {
     ...
     * @memberof ArtworkCRUDApi
     */
    public async postForm(title?: string, description?: string, tags?: string, isExplicit?: number, scheduledPost?: string, files?: Array<Blob>, fileOrder?: Array<number>, allowRedraw?: number, redrawOf?: number, redrawInMyStyle?: number, isOriginalCharacter?: number, options?: AxiosRequestConfig) : Promise<AxiosResponse<InlineResponse2011>> {
        return ArtworkCRUDApiFp(this.configuration).postForm(title, description, tags, isExplicit, scheduledPost, files, fileOrder, allowRedraw, redrawOf, redrawInMyStyle, isOriginalCharacter, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * 
     * @summary Update existing artwork information
