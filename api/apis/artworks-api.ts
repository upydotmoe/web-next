...
export const ArtworksApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        async checkArtworkAvailability(options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => Promise<AxiosResponse<InlineResponse20019>>> {
...
export const ArtworksApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
         ...
         * @throws {RequiredError}
         */
        async checkArtworkAvailability(options?: AxiosRequestConfig): Promise<AxiosResponse<InlineResponse20019>> {
...
export class ArtworksApi extends BaseAPI {
     ...
     */
    public async checkArtworkAvailability(options?: AxiosRequestConfig) : Promise<AxiosResponse<InlineResponse20019>> {
