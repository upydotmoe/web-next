...
export const ArtworkCommentsLikesApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        async likeAComment(id: number, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => Promise<AxiosResponse<InlineResponse20025>>> {
...
export const ArtworkCommentsLikesApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
         ...
         * @throws {RequiredError}
         */
        async likeAComment(id: number, options?: AxiosRequestConfig): Promise<AxiosResponse<InlineResponse20025>> {
...
export class ArtworkCommentsLikesApi extends BaseAPI {
     ...
     */
    public async likeAComment(id: number, options?: AxiosRequestConfig) : Promise<AxiosResponse<InlineResponse20025>> {
