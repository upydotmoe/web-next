...
export const ArtworkLikesApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        async countLikes(id: number, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => Promise<AxiosResponse<InlineResponse20011>>> {
         ...
         * @throws {RequiredError}
         */
        async getUsersLikedAnArtwork(workId: number, perPage: number, page: number, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => Promise<AxiosResponse<InlineResponse20015>>> {
...
export const ArtworkLikesApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
         ...
         * @throws {RequiredError}
         */
        async countLikes(id: number, options?: AxiosRequestConfig): Promise<AxiosResponse<InlineResponse20011>> {
         ...
         * @throws {RequiredError}
         */
        async getUsersLikedAnArtwork(workId: number, perPage: number, page: number, options?: AxiosRequestConfig): Promise<AxiosResponse<InlineResponse20015>> {
...
export class ArtworkLikesApi extends BaseAPI {
     ...
     */
    public async countLikes(id: number, options?: AxiosRequestConfig) : Promise<AxiosResponse<InlineResponse20011>> {
     ...
     * @memberof ArtworkLikesApi
     */
    public async getUsersLikedAnArtwork(workId: number, perPage: number, page: number, options?: AxiosRequestConfig) : Promise<AxiosResponse<InlineResponse20015>> {
