...
export const ArtworksRedrawsApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        async countRedraws(workId: number, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => Promise<AxiosResponse<InlineResponse20017>>> {
...
export const ArtworksRedrawsApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
         ...
         * @throws {RequiredError}
         */
        async countRedraws(workId: number, options?: AxiosRequestConfig): Promise<AxiosResponse<InlineResponse20017>> {
