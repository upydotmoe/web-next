...
export const ArtworksUserApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         */
        getUserLikedArtworks: async (userId: string, page: number, perPage: number, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
...
export const ArtworksUserApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        async getUserLikedArtworks(userId: string, page: number, perPage: number, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => Promise<AxiosResponse<InlineResponse20025>>> {
...
export const ArtworksUserApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
         ...
         * @throws {RequiredError}
         */
        async getUserLikedArtworks(userId: string, page: number, perPage: number, options?: AxiosRequestConfig): Promise<AxiosResponse<InlineResponse20025>> {
...
export class ArtworksUserApi extends BaseAPI {
     ...
     */
    public async getUserLikedArtworks(userId: string, page: number, perPage: number, options?: AxiosRequestConfig) : Promise<AxiosResponse<InlineResponse20025>> {
