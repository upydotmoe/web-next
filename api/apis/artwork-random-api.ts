...
export const ArtworkRandomApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        async getRandomArtwork(options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => Promise<AxiosResponse<InlineResponse20033>>> {
...
export const ArtworkRandomApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
         ...
         * @throws {RequiredError}
         */
        async getRandomArtwork(options?: AxiosRequestConfig): Promise<AxiosResponse<InlineResponse20033>> {
...
export class ArtworkRandomApi extends BaseAPI {
     ...
     */
    public async getRandomArtwork(options?: AxiosRequestConfig) : Promise<AxiosResponse<InlineResponse20033>> {
